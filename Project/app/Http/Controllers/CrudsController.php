...
class CrudsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image->move(public_path('images'), $new_name);     // public_path('images') return public folder path
        $form_data = array(
        ...
        // store success message in success variable and return to index method of CrudsController
